...
export default function Welcome() {
  ...
  const handleRegister = () => {
    ...
    createUserWithEmailAndPassword(
      auth, registerInformation.email, registerInformation.password
    )
      .then(() => {
        navigate("/homepage");
      })
  ...
  return (
    <div className="welcome">
      ...
      <div className="login-register-container">
        {isRegistering ? (
          <>
          <input type="name" placeholder="Name" value={registerInformation.name} onChange={(e) =>
            ...
            />
            <input type="phone" placeholder="Phone" value={registerInformation.phone} onChange={(e) =>
                setRegisterInformation({
                  ...registerInformation,
            ...
            />
            <input type="Address" placeholder="Physical Address" value={registerInformation.P_Address} onChange={(e) =>
                setRegisterInformation({
                  ...registerInformation,
